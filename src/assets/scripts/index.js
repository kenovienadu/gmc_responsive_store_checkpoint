const items = [
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "price": "$23.00",
        "description": "Savory mushrooms, Swiss cheese, caramelized onions, and a beef patty.",
        "image": "assets/img/product-images/burger-4.jpg"
      }
    ]
  },
  {
    ...
    "products": [
      {
        ...
        "image": "assets/img/product-images/pizza-1.webp"
      },
      {
  ...
  },
  {
    ...
    "products": [
      ...
      },
      {
        "name": "Pumpkin Pie",
        "price": "$16.00",
        "description": "Smooth pumpkin filling with warm spices in a golden crust.",
        "image": "assets/img/product-images/pie-3.webp"
      },
      {
        "name": "Key Lime Pie",
        "price": "$17.00",
        "description": "Tangy key lime custard in a graham cracker crust, topped with whipped cream.",
        "image": "assets/img/product-images/pie-4.jpg"
      }
    ]
  }
]
